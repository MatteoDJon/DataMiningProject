...
def eval_other_model(model, features, labels,output_path,DS):
    prediction=model.predict(features)
    performance_measures=compute_AAMI_performance_measures(prediction,labels)
    write_AAMI_results(performance_measures, output_path + '/' + DS + '.txt')
