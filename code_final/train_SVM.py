...
def main(multi_mode='ovo', winL=90, winR=90, do_preprocess=True, use_weight_class=True, 
    ...
    if do_cross_val:
        ...
        perf_measures_path = create_svm_model_name('C:/Users/Matteo/Desktop/data_mining_prog/ecg-classification-master/python/results/' + multi_mode, winL, winR, do_preprocess,
